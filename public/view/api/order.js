...
//  * 电脑订单统计数据
// */
// export function getComputerOrderData() {
//   return request.get('order/data');
// }
/**
 * 打印机维修列表
 * @param object data
*/
export function getPrinterOrderList(data) {
  return request.get('getprinter', data);
}
/**
 * 电脑维修列表
 * @param object data
*/
export function getComputerOrderList(data) {
  return request.get('getcomputer', data);
}
/**
 * 获取购物车列表
 * 
