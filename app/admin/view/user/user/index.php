...
<script>
    ...
    layList.tableList('userList',"{:Url('get_user_list')}",function () {
        return [
            ...
            {field: 's_type', title: '用户类型',align:'center',width:'5%'},
            {field: 'stu_num', title: '学号或工号',align:'center',width:'12%'},
            {field: 'college', title: '学院',align:'center',width:'8%'},
            // {field: 'now_money', title: '余额',width:'6%',sort:true,event:'now_money',align:'center'},
            {field: 'pay_count', title: '维修次数',align:'center',width:'6%'},
            ...
            {field: 'data_time', title: '访问日期',align:'center',width:'16%',templet:'#data_time'},
