        ...
        <div class="col-sm-3 ui-sortable">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <small><a href="javascript:;" class="opFrames" data-name="维修管理" data-href="{:Url('order.store_order/index',['status'=>1])}">待发货</a> </small>
                </div>
            </div>
        </div>
        <div class="col-sm-3 ui-sortable">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <small><a href="javascript:;" class="opFrames" data-name="维修管理" data-href="{:Url('order.store_order/index',['status'=>-1])}">退换货</a></small>
                </div>
            </div>
        </div>
        <div class="col-sm-3 ui-sortable" >
        ...
        <div class="col-sm-3 ui-sortable">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <small><a href="javascript:;" class="opFrames" data-name="维修管理" data-href="{:Url('order.store_order/index')}?data=yesterday">昨日支付维修数</a></small>
                </div>
            </div>
        </div>
        <div class="col-sm-3 ui-sortable">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <small><a href="javascript:;" class="opFrames" data-name="维修管理" data-href="{:Url('order.store_order/index')}?data=yesterday">昨日交易额</a></small>
                </div>
            </div>
        </div>
        <div class="col-sm-3 ui-sortable">
                        ...
                        <div class="col-lg-3">
                            <ul class="stat-list">
                                ...
                                <li>
                                    ...
                                    <small>{{precyclename}}维修总数</small>
                                </li>
                                <li>
                                    <h2 class="no-margins">{{cyclecount}}</h2>
                                    <small>{{cyclename}}维修总数</small>
