...
// Route::post('admin/school', 'admin.School/index')->name('School');
//账号密码登录
...
Route::group(function () {
    ...
    //lancercd 修改
    //用户类  电脑
    Route::get('computer/detail/:id', 'user.UserController/computer')->name('computer');//获取单个地址
    Route::get('computer/list', 'user.UserController/computer_list')->name('computerList');//地址列表
    Route::post('computer/default/set', 'user.UserController/computer_default_set')->name('computerDefaultSet');//设置默认地址
    Route::get('computer/default', 'user.UserController/computer_default')->name('computerDefault');//获取默认地址
    Route::post('computer/edit', 'user.UserController/computer_edit')->name('computerEdit');//修改 添加 地址
    Route::post('computer/del', 'user.UserController/computer_del')->name('computerDel');//删除地址
    // lancercd
    Route::post('user/setSchUserType', 'user.UserController/set_sch_userType')->name('setSchUserType');
	  Route::get('getprinter', 'user.UserController/get_printer_order')->name('printerOrder');//活动状态
	  Route::get('getcomputer', 'user.UserController/get_computer_order')->name('computerOrder');//活动状态

    //用户类  打印机
    Route::get('printer/detail/:id', 'user.UserController/printer')->name('printer');//获取单个地址
    Route::get('printer/list', 'user.UserController/printer_list')->name('printerList');//地址列表
    Route::post('printer/default/set', 'user.UserController/printer_default_set')->name('printerDefaultSet');//设置默认地址
    Route::get('printer/default', 'user.UserController/printer_default')->name('printerDefault');//获取默认地址
    Route::post('printer/edit', 'user.UserController/printer_edit')->name('printerEdit');//修改 添加 地址
    Route::post('printer/del', 'user.UserController/printer_del')->name('printerDel');//删除地址
    Route::get('printer/record', 'user.UserController/printer_record')->name('printerrecord');//打印机型号记录
    Route::get('computer/record', 'user.UserController/computer_record')->name('computerrecord');//电脑型号记录
    Route::get('printer/record', 'user.UserController/printer_record')->name('printerrecord');//电脑型号记录
...
Route::group(function () {
    ...
    //修改 lancercd
    Route::get('save', 'store.CategoryController/save')->name('save');
    Route::get('categoryList', 'store.CategoryController/categoryList')->name('categoryList');
...
Route::post('test', 'User.UserController/test');
Route::miss(function() {
